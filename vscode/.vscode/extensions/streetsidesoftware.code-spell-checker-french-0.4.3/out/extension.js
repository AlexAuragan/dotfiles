...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('cSpellExt_french.enable', () => enable(true)), vscode.commands.registerCommand('cSpellExt_french.disable', () => disable(true)), vscode.commands.registerCommand('cSpellExt_french.enableWorkspace', () => enable(false)), vscode.commands.registerCommand('cSpellExt_french.disableWorkspace', () => disable(false)));
    //
}
